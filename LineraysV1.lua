    -- Linerays Hub V1 by Anon | Neverlose UI
...
local baseSwear = {"skill issue","get good kid","ratio + L","mad cuz bad","touch grass","you're washed","cry about it","noob alert","bot detected","L player","you're so bad it's funny","keep coping","seethe","stay mad","dog water","negative rizz","0 aura","you're actually garbage","free win for me","how are you this bad","imagine losing to me","huge skill gap","walking L","delete roblox","you're a joke","cope harder"}
...
local baseScary = {"I'm right behind you...","Don't turn around 👀","I can see you","Why are you running?","It's too late now","Look up","Close the door...","They're coming","Sweet dreams...","I never left","I'm under your bed","Look behind you","The lights are flickering","It's watching you","Run while you can","You can't hide","I see everything","Turn off the lights","It's closer now","You're not alone"}
...
AITab:CreateButton({Name = "🔥 Rizz AI - Copy Random Line", Callback = function()
    ...
    Library:Notify("Rizz AI", "Copied to clipboard!", 5)
end})

Library:Notify("Linerays Hub V1", "Loaded with 500+ Lines Per Tab!", 8)
