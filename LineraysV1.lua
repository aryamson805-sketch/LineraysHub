...
local scaryLines = {"I'm right behind you...","Don't turn around 👀","I can see you","Why are you running?","It's too late now","Look up","They're coming","Sweet dreams...","I never left","You can't hide"}
...
TrollTab:CreateButton({Name = "🎲 Random Troll Command", Callback = function()
    local cmds = {
...
AITab:CreateButton({Name = "🔥 Rizz AI - Copy Random Line", Callback = function()
    ...
    game:GetService("StarterGui"):SetCore("SendNotification", {Title = "Rizz AI", Text = "Copied to clipboard! Ctrl + V", Duration = 5})
end})

Rayfield:Notify({
    Title = "Linerays Hub V1",
    Content = "Fully Loaded & Fixed!",
    Duration = 6,
    Image = 4483362458
})
